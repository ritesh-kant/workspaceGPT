...
import { Disposable, Uri } from './types';
...
export const languages = {
   ...
   */
  getDiagnostics: notSupported('languages.getDiagnostics', 'no language servers run in the desktop yet (Phase 2: tsc/eslint runner)'),
