...
export const REMOTE_TASK_MODELS: Record<LlmTask, { provider: string; model: string }> = {
  chat: { provider: 'Gemini', model: 'models/gemini-2.5-flash' },
  codegen: { provider: 'Gemini', model: 'models/gemini-2.5-pro' },
  classification: { provider: 'Gemini', model: 'models/gemini-2.5-flash-lite' },
  title: { provider: 'Gemini', model: 'models/gemini-2.5-flash-lite' },
};
