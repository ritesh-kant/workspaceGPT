// ../../apps/vscode-extensions/src/services/agent/shipHelpers.ts
function slugify(text, max = 40) {
  return text.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, "").slice(0, max).replace(/-+$/g, "") || "agent-change";
}
function pullRequestUrl(remoteUrl, base, branch, title, body) {
